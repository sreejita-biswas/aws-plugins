...
func main() {
	...
	success = getClodWatchClient(awsSession)
	if !success {
		return
	}
	metrics := getMetrics()
...
func getFlags() {
	...
	flag.StringVar(&elbName, "elb_name", "", "Name of the Elastic Load Balancer")
	...
	flag.Int64Var(&fetchAge, "fetch_age", 60, "How long ago to fetch metrics for in seconds")
